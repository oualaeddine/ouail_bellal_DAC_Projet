 ...
 */
public class RobotPollueur extends Thread implements Robot {
    Boolean isLive = true;Boolean enough=true;
    ...
    public RobotPollueur(Position position, String name, Dir d) {
    ...
    public void run() {
        ...
        try {
            ...
            interrupt();
            //Monde.countDownLatch.countDown();
    ...
    public void ajouter() throws InterruptedException {
        ...
        Monde.btn[position.getX()][position.getY()].setImage(new Image("img\\searching.png"));
    }
    ...
    public void traversee_H(int step) throws InterruptedException {
        if(energie-step>=0){
            if (position.getY() + step < 10) {
                ...
                Monde.btn[position.getX()][position.getY()].setImage(new Image("img\\pollue.png"));
    ...
    public void chargerEnergie(int plus,int x,int y){
        enough=false;
        Monde.btn[x][y].setImage(new Image("img\\searching2.png"));
